...
namespace Eval
{
	...
	public:
		...
		void r8_tied_only_on_db(Note_Evaluation& evaluated_note, Music_Note& note, Rule_Evaluation& evaluation);
		void r9_prohibited_resolves(Note_Evaluation& evaluated_note, Music_Note& note, Music_Note& last_note, Note_Evaluation& last_evaluated_note, Rule_Evaluation& evaluation);
		void r10_eights_notes(Note_Evaluation& evaluated_note, Music_Note& note, Note_Evaluation& next_note_eval, Rule_Evaluation& evaluation);
	};
}
